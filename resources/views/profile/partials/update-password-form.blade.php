        ...
        <form method="post" action="{{ route('password.update') }}" class="mt-4 space-y-4">
            ...
            <div>
                ...
                <x-text-input id="update_password_current_password" name="current_password"
                    type="password" class="mt-1 block w-full form-input" autocomplete="current-password" />
            ...
            <div>
                ...
                <x-text-input id="update_password_password" name="password" type="password"
                    class="mt-1 block w-full form-input" autocomplete="new-password" />
            ...
            <div>
                ...
                <x-text-input id="update_password_password_confirmation" name="password_confirmation"
                    type="password" class="mt-1 block w-full form-input" autocomplete="new-password" />
